		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 Dockerized",
									"targetURL": "#sapui5dockerized-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5dockerized-display": {
								"semanticObject": "sapui5dockerized",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5dockerized",
									"url": sap.ui.require.toUrl("sapui5dockerized")
								}
							}
						}
					}
